...
urlpatterns = [
    ...
    path('historico_testes_mesa/', TestesMesaView.as_view(), name='historico_testes_mesa'),
    ...
    path('historico_dicionario/<int:pk>', DicionarioView.as_view(), name='historico_dicionario'),
    path('historico_valores_parametros/<int:pk>', ValoresParametrosView.as_view(), name='historico_valores_parametros'),
