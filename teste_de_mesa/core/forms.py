...
class TesteMesaForm(forms.Form):
    code_editor_o = forms.CharField(label='Codigo do programa O', widget=forms.Textarea())
    code_editor_p = forms.CharField(label='Codigo do programa P', widget=forms.Textarea())
