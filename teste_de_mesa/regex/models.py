...
class DadosTeste(models.Model):
    ...
    variavel_p = models.CharField(max_length=1000)
    dado_hexa_p = models.CharField(max_length=1000)
...
class AgrupamentoIndex(models.Model):
    entrada = models.CharField(max_length=1000, db_index=True)
    valor = models.CharField(max_length=1000, db_index=True, null=True)
