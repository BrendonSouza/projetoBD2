...
CREATE TABLE IF NOT EXISTS `regex_agrupamentoindex` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `entrada` varchar(240) NOT NULL,
  `valor` varchar(240) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `regex_dadosteste` (
  ...
  `variavel_p` varchar(100) NOT NULL,
  `dado_hexa_p` varchar(100) NOT NULL,
  `teste_id` bigint(20) NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `regex_employee` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `seu_codigo` varchar(100) NOT NULL,
  PRIMARY KEY (`id`)
